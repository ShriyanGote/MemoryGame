    ...
    render(){
        return (
            ...
            "number-box"}, 
                ...
                main, " - ", this.props.level.sub),
                React.createElement("p", {className: 
                "mistakes"}, "Wrong: ", this.props.
                wrong, "/3")), 
            React.createElement("p", {className: 
            "divider"}, "============================"), 
            React.createElement("p", {className: 
            "number", id: "number"}, this.props.wrong < 
    ...
    render(){
        ...
        if (this.props.wrong < 3){
            ...
            layout = React.createElement("div", {className: "notif-box"},
                React.createElement("div", {className: "notif"}, "Good attempt! Let's see you try again!"),
                React.createElement("br", null),
                    React.createElement("br", null),
                    React.createElement("button", {onClick: this.handleReset}, "Restart"));
...
class App extends React.Component{
    ...
    randomGenerate(digit){
        let max = Math.pow(10, digit) - 1, min = Math.pow(10, digit - 1);
